...
//Function prototypes
static int64_t separator_msg(HLH_gui_element *e, HLH_gui_msg msg, int64_t di, void *dp);
...
static void separator_draw(HLH_gui_separator *s)
{
   HLH_gui_draw_rectangle_fill(&s->e, s->e.bounds, HLH_gui_theme_current.border);
}
//-------------------------------------
