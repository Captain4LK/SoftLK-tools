...
static void radiobutton_draw(HLH_gui_radiobutton *r)
{
   ...
   if(r->is_icon)
   {
      ...
      //Infill
      HLH_gui_draw_rectangle_fill(&r->e, HLH_gui_rect_make(bounds.minx + scale, bounds.miny + scale, bounds.maxx - scale, bounds.maxy - scale), 0xff5a5a5a);
      ...
      {
         HLH_gui_draw_rectangle_fill(&r->e, HLH_gui_rect_make(bounds.minx + 1 * scale, bounds.miny + 2 * scale, bounds.minx + 2 * scale, bounds.maxy - 2 * scale), 0xff323232);
   ...
   if(style==HLH_GUI_STYLE_00)
   {
      ...
      //Infill
      HLH_gui_draw_rectangle_fill(&r->e, HLH_gui_rect_make(bounds.minx + HLH_gui_get_scale(), bounds.miny + HLH_gui_get_scale(), bounds.maxx - HLH_gui_get_scale(), bounds.maxy - HLH_gui_get_scale()), 0xff5a5a5a);
      ...
      HLH_gui_draw_rectangle_fill(&r->e, HLH_gui_rect_make(bounds.minx + offset + 1 * scale, bounds.miny + offset + scale, bounds.minx + offset + 2 * scale, bounds.maxy - offset), 0xffc8c8c8);
      HLH_gui_draw_rectangle_fill(&r->e, HLH_gui_rect_make(bounds.minx + offset + 1 * scale, bounds.maxy - offset - scale, bounds.minx + offset + dim, bounds.maxy - offset), 0xffc8c8c8);

      HLH_gui_draw_rectangle_fill(&r->e, HLH_gui_rect_make(bounds.minx + offset + 2 * scale, bounds.miny + offset, bounds.minx + offset + dim + 1 * scale, bounds.miny + offset + scale), 0xff323232);
      HLH_gui_draw_rectangle_fill(&r->e, HLH_gui_rect_make(bounds.minx + dim + offset + 0 * scale, bounds.miny + offset + scale, bounds.minx + dim + offset + 1 * scale, bounds.maxy - offset - scale), 0xff323232);

      HLH_gui_draw_string(&r->e, HLH_gui_rect_make(bounds.minx + dim + 2 * scale, bounds.miny, bounds.maxx, bounds.maxy), r->text, r->text_len, 0xff000000, 1);

      if(r->checked)
         HLH_gui_draw_rectangle_fill(&r->e, HLH_gui_rect_make(bounds.minx + offset + 4 * scale, bounds.miny + offset + 3 * scale, bounds.minx + dim + offset - 2 * scale, bounds.miny + offset - 3 * scale + dim), 0xff000000);
   }
   else if(style==HLH_GUI_STYLE_01)
   {
      ...
      if(r->state)
         HLH_gui_draw_rectangle_fill(&r->e, bounds, 0xff323232);
      else
         HLH_gui_draw_rectangle_fill(&r->e, bounds, 0xff5a5a5a);
