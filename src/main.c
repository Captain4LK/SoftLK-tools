...
int main(int argc, char **argv)
{
   ...
   SLK_layer_create(1,SLK_LAYER_RGB); //Layer for input preview
   SLK_layer_create(2,SLK_LAYER_RGB); //Layer for output preview
   SLK_layer_create(3,SLK_LAYER_RGB); //Layer for background
